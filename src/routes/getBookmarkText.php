...
$app->post('/api/Instapaper/getBookmarkText', function ($request, $response) {
    ...
    $query_str = "https://www.instapaper.com/api/1/bookmarks/get_text";
    ...
    try {
        ...
        $responseJson['text'] = $responseBody;
